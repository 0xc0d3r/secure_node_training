...
exports.addRequestLogger = (app) => {
    app.use(expressWinston.logger({
        ...
        // TODO LAB TASK 2: Include request matadata (fetched using this.getRequestMeta()) in the log entry
        // Refer to `dynamicMeta` express-winston options here: https://www.npmjs.com/package/express-winston#options

        // TODO LAB TASK 3: Blacklist logging password if sent in request body
        // Refer to `bodyBlacklist` express-winston options here: https://www.npmjs.com/package/express-winston#options

        // TODO LAB TASK 4: Prevent logging Non-Printable and line feed characters. You can use the requestFilter() function in this file 
