...
// LAB Solution
// Task 1: Declare validation schema for a signin request, to require username and password  to be non-empty strings
const signinSchema = Joi.object({
    username: Joi.string().required(),
    password: Joi.string().required()
});

// Task 2: Validate signin request body against Joi schema.
